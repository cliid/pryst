 ...
 * variables {@link PrystNodeFactory#addFormalParameter in the method prologue}.
 */
public class PrystReadArgumentNode extends PrystExpressionNode {
    ...
    public PrystReadArgumentNode(int index) {
        this.index = index;
    }
