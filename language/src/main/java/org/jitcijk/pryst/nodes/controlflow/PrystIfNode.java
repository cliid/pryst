...
public final class PrystIfNode extends PrystStatementNode {
    ...
    /**
     * The condition of the {@code if}. This in a {@link PrystExpressionNode} because we require a
    ...
    /** Statement (or {@link PrystBlockNode block}) executed when the condition is true. */
    @Child private PrystStatementNode thenPartNode;

    /** Statement (or {@link PrystBlockNode block}) executed when the condition is false. */
    @Child private PrystStatementNode elsePartNode;
