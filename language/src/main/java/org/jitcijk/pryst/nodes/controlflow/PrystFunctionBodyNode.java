 ...
 * {@link PrystNull#SINGLETON default null value}.
 */
@NodeInfo(shortName = "body")
public final class PrystFunctionBodyNode extends PrystExpressionNode {
     ...
     * {@link PrystReturnNode explicit return statement}. This allows the compiler to generate better
     * code.
     */
    private final BranchProfile exceptionTaken = BranchProfile.create();
    private final BranchProfile nullTaken = BranchProfile.create();

    public PrystFunctionBodyNode(PrystStatementNode bodyNode) {
