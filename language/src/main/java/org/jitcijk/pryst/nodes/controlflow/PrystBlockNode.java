...
public final class PrystBlockNode extends PrystStatementNode implements BlockNode.ElementExecutor<PrystStatementNode> {
     ...
     * bailout.
     */
    @Child private BlockNode<PrystStatementNode> block;

    public PrystBlockNode(PrystStatementNode[] bodyNodes) {
        /*
     ...
     * {@link PrystStatementNode#executeVoid} method of all children to be inlined.
     */
    @Override
    ...
    public List<PrystStatementNode> getStatements() {
        if (block == null) {
     ...
     */
    public void executeVoid(VirtualFrame frame, PrystStatementNode node, int index, int argument) {
