...
import org.jitcijk.pryst.nodes.interop.NodeObjectDescriptor;
...
@NodeField(name = "nameNode", type = PrystExpressionNode.class)
public abstract class PrystWriteLocalVariableNode extends PrystExpressionNode {
     ...
     */
    protected abstract PrystExpressionNode getNameNode();
    ...
    public Object getNodeObject() {
        PrystExpressionNode nameNode = getNameNode();
