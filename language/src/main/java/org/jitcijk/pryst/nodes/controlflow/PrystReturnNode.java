...
public final class PrystReturnNode extends PrystStatementNode {

    @Child private PrystExpressionNode valueNode;

    public PrystReturnNode(PrystExpressionNode valueNode) {
    ...
    public void executeVoid(VirtualFrame frame) {
        ...
        throw new PrystReturnException(result);
    }
}
