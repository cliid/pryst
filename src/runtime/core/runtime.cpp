...
namespace pryst {
    // Move GC initialization to be called explicitly from main
    void initialize_gc() {
        std::cerr << "DEBUG: Starting Garbage Collector initialization..." << std::endl;
        std::cerr << "DEBUG: GC temporarily disabled for testing" << std::endl;
        // Temporarily disable GC for testing type system
        return;
    }
}
