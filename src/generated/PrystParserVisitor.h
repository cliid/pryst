...
public:
   ...
   */
    ...
    virtual std::any visitUsingDecl(PrystParser::UsingDeclContext *context) = 0;
    ...
    virtual std::any visitNewExpr(PrystParser::NewExprContext *context) = 0;
    ...
    virtual std::any visitTryCatchStmt(PrystParser::TryCatchStmtContext *context) = 0;
