...
public:
  ...
  enum {
    ...
    RuleNamedFunction = 8, RuleLambdaFunction = 9, RuleBlock = 10, RuleVariableDecl = 11, 
    RuleClassDecl = 12, RuleClassBody = 13, RuleClassMember = 14, RuleParamList = 15, 
    RuleParam = 16, RuleParamTypeList = 17, RuleType = 18, RuleStatement = 19, 
    RuleExpression = 20, RuleStringLiteral = 21, RuleStringPart = 22, RuleAssignment = 23, 
    RuleLogicOr = 24, RuleLogicAnd = 25, RuleEquality = 26, RuleComparison = 27, 
    RuleAddition = 28, RuleMultiplication = 29, RuleUnary = 30, RulePostfix = 31, 
    RuleSuffix = 32, RuleCallSuffix = 33, RuleMemberSuffix = 34, RuleCall = 35, 
    RulePrimary = 36, RuleQualifiedIdentifier = 37, RuleNewExpr = 38, RuleArguments = 39, 
    RuleTypeCastExpr = 40, RuleTypeConversionExpr = 41, RuleClassConversionExpr = 42, 
    RuleTryCatchStmt = 43
  };
  ...
  public:
    ...
    antlr4::tree::TerminalNode *STR_TYPE();
  ...
  public:
    ...
    ExpressionContext *expression();
    antlr4::tree::TerminalNode *INTERP_END();
